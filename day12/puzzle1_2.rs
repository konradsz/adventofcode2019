...
fn apply_gravity(moons: &mut Vec<Moon>, index1: usize, index2: usize) {
    if moons[index1].position.x > moons[index2].position.x {
        moons[index1].velocity.x -= 1;
        moons[index2].velocity.x += 1;
    } else if moons[index1].position.x < moons[index2].position.x {
        moons[index1].velocity.x += 1;
        moons[index2].velocity.x -= 1;
    }

    if moons[index1].position.y > moons[index2].position.y {
        moons[index1].velocity.y -= 1;
        moons[index2].velocity.y += 1;
    } else if moons[index1].position.y < moons[index2].position.y {
        moons[index1].velocity.y += 1;
        moons[index2].velocity.y -= 1;
    }

    if moons[index1].position.z > moons[index2].position.z {
        moons[index1].velocity.z -= 1;
        moons[index2].velocity.z += 1;
    } else if moons[index1].position.z < moons[index2].position.z {
        moons[index1].velocity.z += 1;
        moons[index2].velocity.z -= 1;
    }
}
...
fn calculate_total_energy(moons: &Vec<Moon>) -> i32 {
    moons
        .iter()
...
fn main() {
    let mut moons = vec![
        Moon::new(Position { x: 16, y: -8, z: 13 }),
    ...
    println!("{}", calculate_total_energy(&moons));
